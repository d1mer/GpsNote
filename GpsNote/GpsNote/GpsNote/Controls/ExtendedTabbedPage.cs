...
namespace GpsNote.Controls
{
    public class ExtendedTabbedPage : TabbedPage
    {
        ...
        public TabBarPositionType TabBarPosition
        {
            get => (TabBarPositionType)GetValue(TabBarPositionProperty);
        ...
        public DataTemplate TabBarSelectedCellTemplate
        {
            get => (DataTemplate)GetValue(TabBarSelectedCellTemplateProperty);
            set => SetValue(TabBarSelectedCellTemplateProperty, value);
        }
        ...
        {
            get => (Color)GetValue(TopBarColorProperty);
        ...
        {
            get => (double)GetValue(TopBarHeightProperty);
        ...
        {
            get => (Color)GetValue(BottomBarColorProperty);
        ...
        {
            get => (double)GetValue(BottomBarHeightProperty);
        ...
        protected void CreateTabBar()
        {
            ...
            foreach (Page page in Children)
            {
                ...
                cell.BindingContext = page;//.BindingContext ?? page;
